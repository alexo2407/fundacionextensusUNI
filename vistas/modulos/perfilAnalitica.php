    ...
    <div class="container contenido">
        <div class="row">
            <div class="contenido-1 col-md-8 ">
                <h1 style="color:#003891;">Analítica Avanzada con Power BI, R y Python</h1>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/A_A_BI_R_Python.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>

                <h1 style="color:#003891;">Analítica Predicitiva y Machine Learning con R, Python y Databricks</h1>
                <h2>Requisitos de Admisión</h2>
                <p class="text-justify mt-4">Para ser candidato para este curso, los estudiantes deben de cumplir
                    con los siguientes requisitos:
                </p>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/A_P_R_Py_DB.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>

                <h1 style="color:#003891;">Gerencia con Analítica Avanzada para toma de Decisiones</h1>
                <h2>Requisitos de Admisión</h2>
                <p class="text-justify mt-4">Para ser candidato para este curso, los estudiantes deben de cumplir
                    con los siguientes requisitos:
                </p>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/G_A_T_D.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>

                <h1 style="color:#003891;">Ingeniería de Big Data</h1>
                <h2>Requisitos de Admisión</h2>
                <p class="text-justify mt-4">Para ser candidato para este curso, los estudiantes deben de cumplir
                    con los siguientes requisitos:
                </p>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/I_B_D_H_Sp.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>

                <h1 style="color:#003891;">Posgrado en Inteligencia Artificial</h1>
                <h2>Requisitos de Admisión</h2>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/Psg_IA.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>
