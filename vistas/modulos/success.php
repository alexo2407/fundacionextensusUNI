...
<main id="principal">
  <div class="container contenido">
    <div class="row text-center">
      ...
      <div class="col-12 col-md-12">
        <p>Recuerde enviar el comprobante de la transacción al correo <a href="mailto:dirposgrado@pstg.uni.edu.ni" class="link-7">dirposgrado@pstg.uni.edu.ni</a> para proceder
