    ...
    <div class="container contenido">
        <div class="row">
            <div class="contenido-1 col-md-8 ">
                <h1 style="color:#003891;">Inteligencia de Negocios con SQL Server aplicando Power BI</h1>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/I_N_SQL_A_PBI.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>


                <h1 style="color:#003891;">Administración de Bases de Datos con SQL Server 2019</h1>
                <h2>Requerimientos</h2>
                <p class="text-justify mt-4">Para ser candidato para este curso, los estudiantes deben de cumplir
                    con los siguientes requisitos:
                </p>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/Admon_SQL.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>

                <h1 style="color:#003891;">Hacking Ético y Ciberseguridad</h1>
                <h2>Requerimientos</h2>
                <p class="text-justify mt-4">Para ser candidato para este curso, los estudiantes deben de cumplir
                    con los siguientes requisitos:
                </p>
                ...
                <div class="col mb-4">
                    <a href="<?= RUTA_DOMAIN ?>vistas/documents/H_E_C_S.pdf" class="btn btn-primary  w-100" target="blank_">Descargar Pensum</a>
                </div>
